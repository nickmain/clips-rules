...
(union$ (create$) (create$))
(union$ (create$ a b c))
(union$ (create$ a b b c))
(union$ (create$ a b c) (create$ d e f))
(union$ (create$ a b c) (create$ c d e) (create$ e f g))
(intersection$)
(intersection$ 3)
(intersection$ (create$) (create$))
(intersection$ (create$ a b c))
(intersection$ (create$ a b b c))
(intersection$ (create$ a b c) (create$ e f g))
(intersection$ (create$ a b c d e f g) (create$ b d f))
(intersection$ (create$ a b b c d e f g) (create$ b c c d f) (create$ b f b f))
(difference$)
(difference$ 3)
(difference$ (create$) (create$))
(difference$ (create$ a b c))
(difference$ (create$ a b b c))
(difference$ (create$ a b b c d e f g h) (create$ a c))
(difference$ (create$ a b b c d e f g h) (create$ a c) (create$ f h))
